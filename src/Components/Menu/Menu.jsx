...
import newWindow from '../../Images/external-link-icon.png'
import newWindowWhite from '../../Images/external-link-icon-white.png'
    ...
    return (
      ...
      <nav className={`nav ${mode} ${animate} ${display}`}>
        ...
        <ul>
          ...
          <li><a onClick={props.mobileReset} href={resume} target='_blank'>Resume</a><img alt='' className='new-window-icon' src={props.lightMode ? newWindow : newWindowWhite} /></li>
